...
class registro_cliente3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cont_regcliente2.setOnClickListener {
            val pregunta1_cliente = this.pregunta1_cliente.getSelectedItem().toString()
            val respuesta1_cliente = this.respuesta1_cliente.getText().toString()
            val pregunta2_cliente = this.pregunta2_cliente.getSelectedItem().toString()
            val respuesta2_cliente = this.respuesta2_cliente.getText().toString()
            if (pregunta1_cliente.equals("Escoja la primera pregunta")) {
                ...
                if (respuesta1_cliente.equals("")) {
                    ...
                    if (pregunta2_cliente.equals("Escoja la segunda pregunta")) {
                        Toast.makeText(
